...
public class Tools2023 : MonoBehaviour
{
    private static Tools2023 _instance;
    public static Tools2023 Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = new GameObject().AddComponent<Tools2023>();
            }
            return _instance;
        }
    }
    ...
    public IEnumerator GetInput(string day)
    {
        _isProcessing = true;
        _input = "";
        string uri = "https://adventofcode.com/2023/day/" + day.ToString() + "/input";
    ...
    {
        _input = "";
        string uri = "https://adventofcode.com/2023/leaderboard/private/view/" + EasyAccessValues.LeaderboardId + ".json";
